...
public class DepartureTests {
    ...
    public void testDelivery()  {
        ...
        Long shipmentId = 1L;
        when(movementService.updateDepartureByShipmentId( shipmentId)).thenReturn(true);
        HttpEntity<ArrivalRequest> entity = new HttpEntity<>(null, headers);
        ResponseEntity<Object> response = restTemplate.
                exchange("/shipments/1/departure", HttpMethod.POST, entity, Object.class);
    ...
    public void testDeliveryInvalidSqlRequest()  {
        ...
        headers.setContentType(MediaType.APPLICATION_JSON);
        Long shipmentId = 1L;
        when(movementService.updateDepartureByShipmentId( shipmentId)).thenReturn(false);
        HttpEntity<ArrivalRequest> entity = new HttpEntity<>(null, headers);
        ResponseEntity<Object> response = restTemplate.
                exchange("/shipments/1/departure", HttpMethod.POST, entity, Object.class);
